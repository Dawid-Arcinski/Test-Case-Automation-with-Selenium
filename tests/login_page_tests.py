...
class DemoWebsiteTest(BaseTest):
    ...
    def test_tc001_loging_in_using_correct_credentials(self):
        ...
        driver.find_element(*WebStorePageLocators.menu).click()
        logout_link = driver.find_element(*WebStorePageLocators.menu_logout_link)
